...
class ForumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum" do
    assert_difference("Forum.count") do
      post forums_url, params: { forum: { author_id: @forum.author_id, content: @forum.content, title: @forum.title } }
    end
  ...
  test "should update forum" do
    patch forum_url(@forum), params: { forum: { author_id: @forum.author_id, content: @forum.content, title: @forum.title } }
